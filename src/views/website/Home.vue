            ...
            <!-- <b-col md=12> -->
              <b-container fluid>
                <b-row style="width: 80vw;">
                  <b-col xs=12 md=12 style="height: 40vh; border-radius: 2%; background: linear-gradient(to bottom right, #77B2E6, #fff);">
                  </b-col>
                ...
                <b-row style="width: 80vw;">
                  ...
                  <b-col md=12 style="height: 40vh; border-radius: 2%; background: linear-gradient(to bottom right, #77B2E6, #fff);">
                  </b-col>
                </b-row>
              </b-container>
            <!-- </b-col> -->

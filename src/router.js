...
const routes = [
  ...
  { path: '/website/coming',
    component: () => import(/* webpackChunkName: "website" */ './views/website/coming'),
    redirect: 'website/coming/soon',
    children: [
      { path: 'soon', component: () => import(/* webpackChunkName: "website" */ './views/website/coming/Soon') }
    ]
  },

...
<template>
  <div>
    <b-row>
      <b-colxx xxs="12">
        <cbm-breadcrumb :heading="$t('menu.news')"/>
    ...
    <b-row>
      ...
      <b-colxx md="12" lg="12" class="mb-4">
        <gradient-card>
          <b-badge pill variant="theme-3" class="align-self-start mb-3">{{ $t('dashboards.cbm') }}</b-badge>
          <p class="lead text-white">{{ $t('dashboards.your-daily-news') }}</p>
